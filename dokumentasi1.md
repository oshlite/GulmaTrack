...
```
 ...
 Tabel ini menyimpan wilayah produksi (wilayah 16-23). Setiap wilayah memiliki file GeoJSON tersendiri di folder `dataya/` untuk visualisasi peta.
...
// File GeoJSON: dataya/Wil16.geojson, dataya/Wil17.geojson, dst
```
...
**Data Source:**
```
GeoJSON files di folder dataya/:
...
**Solusi:**
```bash
# 1. Cek file GeoJSON ada di folder dataya:
ls -la dataya/
