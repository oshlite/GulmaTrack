...
<style>
    ...
    .hero-section {
        ...
        background: linear-gradient(135deg, rgba(25, 123, 64, 0.65) 0%, rgba(13, 92, 46, 0.75) 100%),
                    url('https://images.unsplash.com/photo-1574943320219-553eb213f72d?w=1920&h=1080&fit=crop') center / cover no-repeat fixed;
        display: flex;
        align-items: center;
        justify-content: center;
        color: white;
    ...
    .btn-hero.primary:hover {
        ...
        box-shadow: 0 10px 40px rgba(166, 206, 57, 0.6);
    }
