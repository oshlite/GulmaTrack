...
<head>
    ...
    <title>GulmaTrack - Sistem Manajemen Hasil Perkebunan</title>
...
<body>
    ...
    <section class="hero">
        <div class="container">
            <div class="hero-content">
                <h1>Kelola Hasil perkebunan Anda dengan Mudah</h1>
                <p>Platform terintegrasi untuk mengelola produksi perkebunan, dari perencanaan hingga distribusi. Tingkatkan produktivitas dan transparansi rantai pasokan Anda.</p>
    ...
    <section class="section" id="tentang">
        <div class="container">
            <div class="section-title">
                ...
                <p>Solusi modern untuk manajemen perkebunan yang berkelanjutan</p>
            </div>

            <div class="content-section">
                <div class="content-text">
                    <h3>Dimulai dengan Misi Sederhana</h3>
                    <p>GulmaTrack didirikan dengan visi untuk menghadirkan teknologi digital ke sektor perkebunan Indonesia. Kami percaya bahwa transparansi dan efisiensi dalam rantai pasokan perkebunan dapat meningkatkan kesejahteraan petani dan kualitas produk.</p>
                ...
                <div class="image-wrapper">
                    <img src="https://images.unsplash.com/photo-1625246333195-78d9c38ad576?w=500&h=500&fit=crop" alt="perkebunan Modern">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section bg-light" id="fitur">
        <div class="container">
            <div class="section-title">
                ...
                <p>Semua yang Anda butuhkan untuk mengelola perkebunan modern</p>
            </div>
            ...
            <div class="features-grid">
                <div class="feature-card">
                    ...
                    <p>Pantau produksi, penjualan, dan performa perkebunan Anda dalam satu dashboard yang komprehensif dan mudah dipahami.</p>
                </div>
    ...
    <section class="section">
        <div class="container">
            <div class="content-section">
                <div class="image-wrapper">
                    <img src="https://images.unsplash.com/photo-1574943320219-553eb213f72d?w=500&h=500&fit=crop" alt="Teknologi perkebunan">
                </div>
                <div class="content-text">
                    <h3>Bekerja dalam Harmoni</h3>
                    <p>Sistem kami dirancang untuk memfasilitasi kerja sama yang harmonis antara semua stakeholder dalam rantai pasokan perkebunan.</p>
    ...
    <section class="section" style="background: linear-gradient(135deg, #128241 0%, #128241 100%); color: white; text-align: center;">
        <div class="container">
            <h2 style="color: white;">Siap untuk Mengubah Bisnis perkebunan Anda?</h2>
